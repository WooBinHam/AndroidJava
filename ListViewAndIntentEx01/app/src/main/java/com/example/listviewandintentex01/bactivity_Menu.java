...
public class bactivity_Menu extends AppCompatActivity {
...
//        tvNum = (TextView) findViewById(R.id.tvNum);
        ...
        for(i=0;i<numButtons.length;i++) {
            ...
            numButtons[index].setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    dialogView = (View) View.inflate(bactivity_Menu.this, R.layout.activity_bdialog2, null);

                    //alertDialog.Builder 생성
                    AlertDialog.Builder dlg = new AlertDialog.Builder(bactivity_Menu.this);
                    dlg.setTitle("수량 입력");
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //Intent
                Intent intent = new Intent(bactivity_Menu.this,bactivity_Pay.class);
