...
public class cactivity_Pay extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnIn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dialogView = (View) View.inflate(cactivity_Pay.this,R.layout.activity_cdialog3,null);

                //alertDialog.Builder 생성
                AlertDialog.Builder dlg = new AlertDialog.Builder(cactivity_Pay.this);
                dlg.setTitle("예약자 성함");
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //Intent
                Intent intent = new Intent(cactivity_Pay.this,cactivity_Finish.class);
