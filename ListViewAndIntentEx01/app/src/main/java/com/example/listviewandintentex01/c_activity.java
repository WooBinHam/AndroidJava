    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnInfo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dialogView = (View) View.inflate(c_activity.this,R.layout.activity_cdialog,null);

                //alertDialog.Builder 생성
                AlertDialog.Builder dlg = new AlertDialog.Builder(c_activity.this);
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //Intent
                Intent intent = new Intent(c_activity.this,cactivity_Menu.class);
