...
public class d_activity extends AppCompatActivity {
    ...
    Integer[] numBtnIDs = { R.id.BtnNum0,R.id.BtnNum1,R.id.BtnNum2,R.id.BtnNum3,R.id.BtnNum4,
            ...
            R.id.BtnNum12, R.id.BtnNum13, R.id.BtnNum14, R.id.BtnNum15,R.id.BtnNum16,
            R.id.BtnNum17,R.id.BtnNum18,R.id.BtnNum19,};
    // 이전 페이지로
    Button btnReturn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnInfo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dialogView = (View) View.inflate(d_activity.this,R.layout.activity_ddialog,null);

                //alertDialog.Builder 생성
                AlertDialog.Builder dlg = new AlertDialog.Builder(d_activity.this);
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //Intent
                Intent intent = new Intent(d_activity.this,d_activity_Menu.class);
