    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnInfo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dialogView = (View) View.inflate(e_activity.this,R.layout.activity_edialog,null);

                //alertDialog.Builder 생성
                AlertDialog.Builder dlg = new AlertDialog.Builder(e_activity.this);
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //Intent
                Intent intent = new Intent(e_activity.this,e_activity_Menu.class);
